def print_upper_words(words):
    """
    or a list of words, print out each word on a separate line, but in all uppercase. How can you change a word to uppercase? Ask Python for help on what you can do with strings!
...
print_upper_words(["hello", "hey", "goodbye", "yo", "yes"],
    ...
    """
    for w in words:
        if w.startswith("h") or w.startswith("y"):
            print(w.upper())